...
namespace SamSoarII.Core.Helpers
{
    public class CSVFileHelper
    {
        ...
        public static void ImportExcute(string filename, ValueManager valuemanager, string separator)
        {
        ...
        public static void ExportExcute(string filename, IEnumerable<ValueInfo> elementCollection, string separator)
        {
