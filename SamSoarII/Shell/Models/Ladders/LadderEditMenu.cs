...
namespace SamSoarII.Shell.Models
{
    public class LadderEditMenu : ContextMenu, IDisposable
    {
        public LadderEditMenu()
        {
            ...
            Image image = null;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/Cut.png"));
            miCut.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/Copy.png"));
            miCopy.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/Paste.png"));
            miPaste.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/Delete.png"));
            miDelete.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/InsertRow.png"));
            miRowInsert.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/DeleteRow.png"));
            miRowDelete.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/InsertRowBefore.png"));
            miRowIBefore.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/InsertRowAfter.png"));
            miRowIAfter.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/InsertRowEnd.png"));
            miRowIEnd.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/InsertNet.png"));
            miNetInsert.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/DeleteNet.png"));
            miNetRemove.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/InsertNetBefore.png"));
            miNetIBefore.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/InsertNetAfter.png"));
            miNetIAfter.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/InsertNetEnd.png"));
            miNetIEnd.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/CopyNet.png"));
            miNetCopy.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/CutNet.png"));
            miNetCut.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/MergeNet.png"));
            miNetMerge.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/SplitNet.png"));
            miNetSplit.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/ExpandIcon.png"));
            Expand.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/Collapse.png"));
            Collapsed.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/ExpandAll.png"));
            ExpandAll.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/CollapseAll.png"));
            CollapsedAll.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/ZoomIn.png"));
            miZoomIn.Icon = image;
            image = new Image();
            image.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/Image/ZoomOut.png"));
            miZoomOut.Icon = image;
