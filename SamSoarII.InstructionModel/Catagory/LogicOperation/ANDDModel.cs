...
{
    public class ANDDModel : BaseModel
    {
        public override string InstructionName => "ANDD";
        ...
        public ANDDModel(DoubleWordValue inputValue1, DoubleWordValue inputValue2, DoubleWordValue outputValue)
        {
