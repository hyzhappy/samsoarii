...
{
    public class MULWModel : BaseModel
    {
        public override string InstructionName => "MULW";
        ...
        public MULWModel(WordValue inputValue1, WordValue inputValue2, WordValue outputValue)
        {
