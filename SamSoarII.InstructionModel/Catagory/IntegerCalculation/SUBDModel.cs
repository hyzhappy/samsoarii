...
{
    public class SUBDModel : BaseModel
    {
        public override string InstructionName => "SUBD";
        ...
        public SUBDModel(DoubleWordValue inputValue1, DoubleWordValue inputValue2, DoubleWordValue outputValue)
        {
