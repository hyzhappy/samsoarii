...
{
    public class ROLViewModel : OutputRectBaseViewModel
    {
        ...
        public override string InstructionName { get { return "ROL"; } }
        public ROLViewModel()
        {
        ...
        private static int CatalogID { get { return 1206; } }
