...
{
    public class SHLViewModel : OutputRectBaseViewModel
    {
        private SHLModel _model;
        ...
        {
            return new SHLViewModel();
        }

        private static int CatalogID { get { return 1200; } }
