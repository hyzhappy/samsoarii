...
{
    public class ORWViewModel : OutputRectBaseViewModel
    {
        private ORWModel _model;
        ...
        {
            return new ORWViewModel();
        }

        private static int CatalogID { get { return 504; } }
