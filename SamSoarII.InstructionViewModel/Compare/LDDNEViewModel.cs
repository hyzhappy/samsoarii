...
{
    public class LDDNEViewModel : InputBaseViewModel
    {
        private LDDNEModel _model;
        ...
        public LDDNEViewModel()
        {
            ...
            Model = new LDDNEModel();
        }

        public override BaseViewModel Clone()
        {
            return new LDDNEViewModel();
        }

        private static int CatalogID { get { return 307; } }
