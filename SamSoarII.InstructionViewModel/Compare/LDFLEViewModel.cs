...
{
    public class LDFLEViewModel : InputBaseViewModel
    {
        private LDFLEModel _model;
        ...
        {
            return new LDFLEViewModel();
        }

        private static int CatalogID { get { return 315; } }
