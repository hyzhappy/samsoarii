...
{
    public class LDWLEViewModel : InputBaseViewModel
    {
        private LDWLEModel _model;
        ...
        public override BaseModel Model
        {
            ...
            protected set
            {
                _model = value as LDWLEModel;
                Value1 = _model.Value1;
                Value2 = _model.Value2;
            }
        }
        public override string InstructionName { get { return "LDWLE"; } }
        public LDWLEViewModel()
        {
            CenterTextBlock.Text = "W<=";
            Model = new LDWLEModel();
        }
        ...
        {
            return new LDWLEViewModel();
        }

        public static int CatalogID { get { return 303; } }
