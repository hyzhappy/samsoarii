...
{
    public class LDFEQViewModel : InputBaseViewModel
    {
        private LDFEQModel _model;
        ...
        public override BaseModel Model
        {
            ...
            protected set
            {
                _model = value as LDFEQModel;
                Value1 = _model.Value1;
                Value2 = _model.Value2;
            }
        }
        public override string InstructionName { get { return "LDFEQ"; } }
        public LDFEQViewModel()
        {
            CenterTextBlock.Text = "F==";
            Model = new LDFEQModel();
        }
        public override BaseViewModel Clone()
        {
            return new LDFEQViewModel();
        }

        private static int CatalogID { get { return 312; } }
