...
{
    public class MULWViewModel : OutputRectBaseViewModel
    {
        private MULWModel _model;
        ...
        public override BaseModel Model
        {
            ...
            protected set
            {
                _model = value as MULWModel;
                InputValue1 = _model.InputValue1;
                InputValue2 = _model.InputValue2;
                OutputValue = _model.OutputValue;
            }
        }
        public override string InstructionName { get { return "MULW"; } }
        public MULWViewModel()
        {
            TopTextBlock.Text = InstructionName;
            _model = new MULWModel();
        }


        public override BaseViewModel Clone()
        {
            return new MULWViewModel();
        }

        private static int CatalogID { get { return 805; } }
