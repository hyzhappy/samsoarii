...
namespace SamSoarII.LadderInstViewModel
{
    public class SUBDViewModel : OutputRectBaseViewModel
    {
        ...
        public override string InstructionName { get { return "SUBD"; } }
        public SUBDViewModel()
        {
            TopTextBlock.Text = InstructionName;
            _model = new SUBDModel();
        ...
        {
            return new SUBDViewModel();
        }

        private static int CatalogID { get { return 803; } }
        ...
        public override void AcceptNewValues(IList<string> valueStrings, Device contextDevice)
        {
            ...
            if (ValueParser.CheckValueString(valueStrings[0], new Regex[] { ValueParser.VerifyDoubleWordRegex1, ValueParser.VerifyIntKHValueRegex }) && ValueParser.CheckValueString(valueStrings[2], new Regex[] { ValueParser.VerifyDoubleWordRegex1, ValueParser.VerifyIntKHValueRegex }) && ValueParser.CheckValueString(valueStrings[4], new Regex[] { ValueParser.VerifyDoubleWordRegex1 }))
            {
