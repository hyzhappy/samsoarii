...
{
    public class SQRTViewModel : OutputRectBaseViewModel
    {
        private SQRTModel _model;
        ...
        {
            return new SQRTViewModel();
        }

        private static int CatalogID { get { return 704; } }
