...
{
    public class LNViewModel : OutputRectBaseViewModel
    {
        private LNModel _model;
        ...
        public override BaseModel Model
        {
            ...
            protected set
            {
                _model = value as LNModel;
                InputValue = _model.InputValue;
                OutputValue = _model.OutputValue;
            }
        }
        public override string InstructionName { get { return "LN"; } }
        public LNViewModel()
        {
        ...
        {
            return new LNViewModel();
        }

        private static int CatalogID { get { return 708; } }
