...
{
    public class EXPViewModel : OutputRectBaseViewModel
    {
        private EXPModel _model;
        ...
        public override string InstructionName { get { return "EXP"; } }
        public EXPViewModel()
        {
        ...
        {
            return new EXPViewModel();
        }

        private static int CatalogID { get { return 709; } }
