...
{
    public class MULFViewModel : OutputRectBaseViewModel
    {
        private MULFModel _model;
        ...
        public override string InstructionName { get { return "MULF"; } }
        public MULFViewModel()
        {
            TopTextBlock.Text = InstructionName;
            _model = new MULFModel();
        ...
        {
            return new MULFViewModel();
        }

        private static int CatalogID { get { return 702; } }
