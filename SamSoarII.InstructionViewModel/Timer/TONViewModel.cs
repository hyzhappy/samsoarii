...
{
    class TONViewModel : OutputRectBaseViewModel
    {
        ...
        public override BaseModel Model
        {
            ...
            protected set
            {
                if (value is TONModel)
                {
                    this.model = (TONModel)(value);
                    TimerValue = model.TimerValue;
                    EndValue = model.EndValue;
                }
                else
                {
                    throw new ArgumentException("Cannot assign value except TONModel.");
                }
            }
        }
        ...
        public WordValue TimerValue
        {
            ...
            set
            {
                ...
                MiddleTextBlock1.Text = String.Format("{0:s}", value.ValueShowString);
            }
        }
        ...
        public WordValue EndValue
        {
            ...
            set
            {
                ...
                MiddleTextBlock2.Text = String.Format("SV:{0:s}", value.ValueShowString);
            }
        }
