    ...
    public class SHLDViewModel : OutputRectBaseViewModel
    {
        ...
        public DoubleWordValue SourceValue
        {
            ...
            set
            {
                ...
                MiddleTextBlock2.Text = string.Format("IN1:{0}", _model.SourceValue.ValueString);
            }
        }
        public WordValue Count
        {
            ...
            {
                _model.Count = value;
                MiddleTextBlock3.Text = string.Format("IN2:{0}", _model.Count.ValueString);
            }
        }
        public DoubleWordValue DestinationValue
        {
            ...
            set
            {
                ...
                BottomTextBlock.Text = string.Format("OUT:{0}", _model.DestinationValue.ValueString);
            }
        }
