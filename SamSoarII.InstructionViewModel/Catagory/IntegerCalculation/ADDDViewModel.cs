...
{
    public class ADDDViewModel : OutputRectBaseViewModel
    {
        private ADDDModel _model;
        ...
        {
            return new ADDDViewModel();
        }

        private static int CatalogID { get { return 801; } }
