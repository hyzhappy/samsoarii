...
{
    public class ZRNViewModel : OutputRectBaseViewModel
    {
        ...
        public override BaseModel Model
        {
            ...
            protected set
            {
                ...
                {
                    throw new ArgumentException("Cannot assign value except ZRNModel");
                }
            }
        }
        ...
        public override void ParseValue(IList<string> valueStrings)
        {
            try
            {
                BackValue = ValueParser.ParseWordValue(valueStrings[0]);
            }
            ...
            try
            {
                CrawValue = ValueParser.ParseWordValue(valueStrings[1]);
            }
            catch (ValueParseException)
            {
