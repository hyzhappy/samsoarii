...
{
    public class DPLSYViewModel : OutputRectBaseViewModel
    {
        ...
        public override BaseModel Model
        {
            ...
            protected set
            {
                if (value is DPLSYModel)
                {
                    this.model = (DPLSYModel)(value);
                }
                else
                {
                    throw new ArgumentException("Cannot assign value except DPLSYModel");
                }
            }
        }
        ...
        public override void ParseValue(IList<string> valueStrings)
        {
            ...
            try
            {
                PulseValue = ValueParser.ParseDoubleWordValue(valueStrings[1]);
            }
            catch (ValueParseException)
            {
        ...
        */
        ...
        public DPLSYViewModel()
        {
            TopTextBlock.Text = InstructionName;
            model = new DPLSYModel();
