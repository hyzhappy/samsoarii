...
{
    public class PLSYViewModel : OutputRectBaseViewModel
    {
        ...
        public override BaseModel Model
        {
            ...
            protected set
            {
                if (value is PLSYModel)
                {
                    this.model = (PLSYModel)(value);
                }
                else
                {
                    throw new ArgumentException("Cannot assign value except PLSYModel");
                }
            }
        }
