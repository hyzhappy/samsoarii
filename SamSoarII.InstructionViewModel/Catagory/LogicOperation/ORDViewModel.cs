...
{
    public class ORDViewModel : OutputRectBaseViewModel
    {
        private ORDModel _model;
        ...
        public override string InstructionName { get { return "ORD"; } }
        public ORDViewModel()
        {
        ...
        {
            return new ORDViewModel();
        }

        private static int CatalogID { get { return 505; } }
