...
{
    public class NEGDViewModel : OutputRectBaseViewModel
    {
        ...
        public override BaseModel Model
        {
            ...
            protected set
            {
                ...
                {
                    throw new ArgumentException("Cannot assign value except NEGDModel.");
                }
            }
        }
