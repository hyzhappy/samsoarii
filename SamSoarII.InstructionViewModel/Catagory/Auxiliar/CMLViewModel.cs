...
{
    public class CMLViewModel : OutputRectBaseViewModel
    {
        ...
        public override BaseModel Model
        {
            ...
            protected set
            {
                if (value is CMLModel)
                {
                    this.model = (CMLModel)(value);
                }
                else
                {
                    throw new ArgumentException("Cannot assign value except CMLModel.");
                }
            }
        }
