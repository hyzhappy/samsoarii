...
{
    public class CMLDViewModel : OutputRectBaseViewModel
    {
        ...
        public override BaseModel Model
        {
            ...
            protected set
            {
                ...
                {
                    throw new ArgumentException("Cannot assign value except CMLDModel.");
                }
            }
        }
