...
{
    public class CTUDViewModel : OutputRectBaseViewModel
    {
        ...
        public override BaseModel Model
        {
            ...
            protected set
            {
                if (value is CTUDModel)
                {
                    this.model = (CTUDModel)(value);
                }
                else
                {
                    throw new ArgumentException("Cannot assign value except CTUDModel.");
                }
            }
        }
