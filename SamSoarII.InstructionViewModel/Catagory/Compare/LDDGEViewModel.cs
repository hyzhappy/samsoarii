...
namespace SamSoarII.LadderInstViewModel
{
    public class LDDGEViewModel : InputBaseViewModel
    {
        ...
        {
            return new LDDGEViewModel();
        }

        private static int CatalogID { get { return 308; } }
