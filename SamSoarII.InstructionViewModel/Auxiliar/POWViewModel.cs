...
{
    class POWViewModel : OutputRectBaseViewModel
    {
        ...
        public override BaseModel Model
        {
            ...
            protected set
            {
                if (value is POWModel)
                {
                    this.model = (POWModel)(value);
                ...
                {
                    throw new ArgumentException("Cannot assign value except POWModel.");
                }
            }
        }
        ...
        public override void ParseValue(IList<string> valueStrings)
        {
            ...
            try
            {
                OutputValue = ValueParser.ParseFloatValue(valueStrings[4]);
            }
            catch (ValueParseException)
            {
