...
namespace SamSoarII.Utility.FileRegister
{
    public class FileTypeRegister
    {
        ...
        public static void RegisterFileType(FileTypeRegInfo regInfo)
        {
            ...
            //HKEY_CLASSES_ROOT/.ssr
            RegistryKey fileTypeKey = Registry.ClassesRoot.CreateSubKey(regInfo.ExtendName,RegistryKeyPermissionCheck.ReadWriteSubTree);
            string relationName = regInfo.ExtendName.Substring(1,regInfo.ExtendName.Length - 1).ToUpper() + "_FileType";
            fileTypeKey.SetValue("", relationName);
            fileTypeKey.Close();

            //HKEY_CLASSES_ROOT/SSR_FileType
            ...
            //HKEY_CLASSES_ROOT/SSR_FileType/Shell
            RegistryKey shellKey = relationKey.CreateSubKey("Shell");

            //HKEY_CLASSES_ROOT/SSR_FileType/Shell/Open
